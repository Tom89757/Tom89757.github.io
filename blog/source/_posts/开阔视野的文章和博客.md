...
### Parsers
1. [How Desmos uses Pratt Parsers - Desmos Engineering](https://engineering.desmos.com/articles/pratt-parser/)：编译器如何将代码解析为AST
...
### 开发实践
1. [答案在代码中：“实现需求”的双重含义 | Piglei](https://www.piglei.com/articles/the-answer-is-in-the-code-fulfill-requirements/)
...
### 其它领域
1. [Visual Information Theory -- colah's blog](https://colah.github.io/posts/2015-09-Visual-Information/)：视觉信息论，通过可视化表示信息。该博客的其它文章也非常推荐，作者引用高达60000

### 有限状态机
1. [XState Visualizer](https://stately.ai/viz)：实现了有限状态机的JS库，设计很简洁
2. 


### 浏览器
1. [Chrome 浏览器运行原理你了解多少？](https://mp.weixin.qq.com/s/wjrcO2Ej7BEThWVsCnXEtA)：介绍了Chrome浏览器的运行原理


### Linux相关
1. [Behind "Hello World" on Linux](https://jvns.ca/blog/2023/08/03/behind--hello-world/)：在Linux上运行一个简单的`.py`文件后，背后发生了什么

### 网络
1. [Why is DNS still hard to learn?](https://jvns.ca/blog/2023/07/28/why-is-dns-still-hard-to-learn/)
2. [有关 TLS/SSL 证书的一切 | 卡瓦邦噶！](https://www.kawabangga.com/posts/5330)

### 内存管理
1. [Measuring Memory Subsystem Performance - Johnny's Software Lab](https://johnnysswlab.com/measuring-memory-subsystem-performance/?utm_source=rss&utm_medium=rss&utm_campaign=measuring-memory-subsystem-performance)

### Code Review
1. [腾讯 13 年，我所总结的Code Review终极大法](https://mp.weixin.qq.com/s/HoFSNCd1U3eoUqYaQiEgwQ)