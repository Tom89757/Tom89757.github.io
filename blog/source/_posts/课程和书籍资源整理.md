...
15. [Create Your Own Compiler - Caught in the Web](https://citw.dev/tutorial/create-your-own-compiler)：互动式地教你动手写编译器。
16. [The faker's guide to reading (x86) assembly language // TimDbg](https://www.timdbg.com/posts/fakers-guide-to-assembly/)：叫你学习x86 assembly language。
...
4. [AI-EDU](https://microsoft.github.io/ai-edu/)：微软社区开源的AI-EDU学习资源
...
### 软件组织
1. [Team, Project, and file organization](https://www.figma.com/best-practices/team-file-organization/)
